...
def plot_candles(df):
    ...
    mpf.plot(df_plot, type="candle", style="charles", volume=True, title="BTCUSDT 4H: 01.11.2021–01.01.2025", ylabel="Цена", ylabel_lower="Объем")
...
if __name__ == "__main__":
    save_and_show("BTCUSDT", "4h", "2021-11-01", "2025-01-01", "../../../../data/binance/BTCUSDT/4h/2021_11_01-2025_01_01.csv")