"""
Конфігурація для торгового середовища STAS_RL.
"""
...
class TradingConfig:
    ...
    # НОВЕ: Портфельна континуальність
    enable_portfolio_continuity: bool = True  # Зберігати портфель між епізодами для справжнього compound зростання
    max_portfolio_drawdown: float = 0.20  # Максимальна cumulative просадка портфеля (20%)
    portfolio_safety_mode: bool = True  # Увімкнути захисний режим при високих втратах
