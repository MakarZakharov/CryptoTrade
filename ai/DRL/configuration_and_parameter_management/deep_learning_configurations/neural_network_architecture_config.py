...
class DRLConfig:
    ...
    # Пути к файлам
    models_dir: str = "CryptoTrade/ai/DRL_NEW/saved_models_and_artifacts"  # Директория для сохранения моделей
    logs_dir: str = "CryptoTrade/ai/DRL_NEW/experimental_results_and_logs"  # Директория для логов
