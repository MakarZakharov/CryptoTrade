"""
Демо-скрипт для тестирования реалистичной торговой среды STAS_ML.
...
from CryptoTrade.ai.STAS_ML.environment.reward_schemes import TradingMetrics
...
def main():
    ...
    print("🚀 Демо реалистичной торговой среды STAS_ML")
    print("=" * 50)
